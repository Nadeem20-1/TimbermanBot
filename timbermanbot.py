...
class TimbermanBot:
    def __init__(self):
        ...
        # Model1 is the original, model2 is untested
        ...
        # Bounding box that crops the game. Will be working on way to 
        # automatically target wherever the window is, and get the coordinates accordingly
        self.bounding_box = {'top': 80, 'left' : 1100, 'width' : 500, 'height': 585}
    ...
    def model_runner(self):
        while True:
            ...
            try:
                sct = mss.mss()
                img = sct.grab(self.bounding_box)
                img = np.array(img)
                ...
                for i, r in enumerate(b):
                    ...
                    if i != index and r != 0:
                        ...
                        if res > 0:
                            ...
                            if b1[index][0] > 500 and self.direction == False or b1[index][0] < 300 and self.direction == True:
